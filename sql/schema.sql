...
) ENGINE=InnoDB AUTO_INCREMENT=53332 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=30371 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `~log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28824 DEFAULT CHARSET=utf8mb4 COMMENT='event logging table for `active_atlas_development`';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-10-16 11:33:11
