    ...
    var DateTimeShortcuts = {
        ...
        clockHours: {
            default_: [
                ...
                [gettext_noop('1 a.m.'), 1],
                [gettext_noop('2 a.m.'), 2],
                [gettext_noop('3 a.m.'), 3],
                [gettext_noop('4 a.m.'), 4],
                [gettext_noop('5 a.m.'), 5],
                [gettext_noop('6 a.m.'), 6],
                [gettext_noop('7 a.m.'), 7],
                [gettext_noop('8 a.m.'), 8],
                [gettext_noop('9 a.m.'), 9],
                [gettext_noop('10 a.m.'), 10],
                [gettext_noop('11 a.m.'), 11],
                [gettext_noop('Noon'), 12],
                [gettext_noop('1 p.m.'), 13],
                [gettext_noop('2 p.m.'), 14],
                [gettext_noop('3 p.m.'), 15],
                [gettext_noop('4 p.m.'), 16],
                [gettext_noop('5 p.m.'), 17],
                [gettext_noop('6 p.m.'), 18],
                [gettext_noop('7 p.m.'), 19],
                [gettext_noop('8 p.m.'), 20],
                [gettext_noop('9 p.m.'), 21],
                [gettext_noop('10 p.m.'), 22],
                [gettext_noop('12 p.m.'), 23],
            ]
        },
        dismissClockFunc: [],
        dismissCalendarFunc: [],
